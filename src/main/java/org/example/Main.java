...
public class Main {
    public static void main(String[] args) {
        ...
        team1.addWarriorToTeam(new Swordman("Jack", 50, new Sword(10),new DefenseShields<Swordman>("iRON",  5)))
                .addWarriorToTeam(new Swordman("Bruce", 100, new Sword(50),new DefenseShields<Swordman>("iRON",  5)))
                .addWarriorToTeam(new Swordman("Donald", 85, new Sword(30),new DefenseShields<Swordman>("iRON",  5)));
        ...
        team2.addWarriorToTeam(new Archer("Igor", 20, new Bow(50, 10), new DefenseShields<Archer>("Wood", 3)))
                .addWarriorToTeam(new Archer("Roman", 100, new Bow(30, 20), new DefenseShields<Archer>("Wood", 4)))
